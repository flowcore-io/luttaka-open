...
import {type CreateConferenceInput, CreateConferenceInputDto} from "@/contracts/conference/conference";
...
export const CreateConferenceForm: FC<CreateConferenceProps> = ({close, refetch}) => {
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className={"space-y-3"}>
        ...
        <div className={"flex justify-end"}>
          <Button type={"submit"}  disabled={createConference.isLoading}>
            { createConference.isLoading && <Loader className={"animate-spin"} /> }
            Create Conference
          </Button>
        </div>
      </form>
