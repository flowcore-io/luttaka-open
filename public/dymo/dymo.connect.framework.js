...
;(goog.global = this),
  ...
  goog.DEPENDENCIES_ENABLED &&
    ...
    (goog.writeScripts_ = function () {
      ...
      for (e = 0; e < r.length; e++) {
        if (!(o = r[e]))
          throw ((goog.moduleLoaderState_ = t), Error("Undefined script input"))
        n.pathIsModule[o]
  ...
  (goog.i18n.bidi.guardBracketInHtml = function (e, o) {
    return (void 0 === o ? goog.i18n.bidi.hasAnyRtl(e) : o)
      ...
      : e.replace(goog.i18n.bidi.bracketGuardHtmlRe_, "<span dir=ltr>$&</span>")
  }),
  ...
  r
    ? goog.net.XhrIo.send(
        ...
        function (e) {
          e.target.isSuccess()
            ? o()
            : (setCachedService(null, null), _findWebService(WS_SVC_HOST, o, g))
        },
        "GET",
        void 0,
        void 0,
